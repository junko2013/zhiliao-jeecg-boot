...
public interface CommonConstant {
    ...
    Integer SC_BIZ_ERROR = 501;
    Integer SC_PARA_ERROR = 502;
    Integer SC_NULL_ERROR = 503;
    /** {@code 500 Server Error} (HTTP/1.0 - RFC 1945) */
    Integer REQUEST_METHOD_ERROR = 504;

    /** 登录用户Shiro权限缓存KEY前缀 */
    public static String PREFIX_USER_SHIRO_CACHE  = "shiro:cache:org.jeecg.config.shiro.ShiroRealm.authorizationCache:";
    /** 登录用户Token令牌缓存KEY前缀 */
    String PREFIX_USER_TOKEN  = "prefix_user_token:";
    /** 应用端登录用户Token令牌缓存KEY前缀 */
    String PREFIX_USER_TOKEN_API  = "prefix_api_user_token_";
//    /** Token缓存时间：3600秒即一小时 */
//    int  TOKEN_EXPIRE_TIME  = 3600;
    ...
    * 用户租户状态(正常/已通过审核的)
    */
   Integer USER_TENANT_NORMAL = 1;

   /**
    * 用户租户状态(离职)
    */
   Integer USER_TENANT_QUIT = 2;

   /**
    * 用户租户状态(审核中)
    */
   Integer USER_TENANT_UNDER_REVIEW = 3;
   
   /**
    * 用户租户状态(拒绝)
    */
   Integer USER_TENANT_REFUSE = 4;

   /**
    * 用户租户状态(邀请)
    */
   Integer USER_TENANT_INVITE = 5;
