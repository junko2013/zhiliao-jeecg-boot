...
public class ClientOperLogAspect {
    ...
    public void saveOperLog(JoinPoint joinPoint, Object keys) {
        ...
        try {
            ...
            userLog.setDeviceIsPhysic(getDeviceIsPhysic(request));
    ...
    protected Boolean getDeviceIsPhysic(HttpServletRequest request){
    ...
    protected Integer getServerId(HttpServletRequest request){
