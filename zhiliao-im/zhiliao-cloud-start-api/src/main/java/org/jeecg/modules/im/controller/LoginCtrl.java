...
//        }
    ...
    public Result<Object> tokenLogin(@RequestParam String token,@RequestParam(required = false) Boolean isScan) {
        // 二次验证成功
        return userService.tokenLogin(token,isScan);
    }
