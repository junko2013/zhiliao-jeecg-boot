...
@TableName(ServerConfig.TABLE_NAME)
public class ServerConfig extends BaseModel<ServerConfig> {

    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "im_server_config";
     ...
     */
    private String signInRewardContinue;
    //单位：金币。每次签到获得的奖励
    ...
    //最多可补签天数，超过该天数则无法补签
    private Integer signInMakeupDays;
    //补签一次所扣除的金币。开启阶梯规则如：1,3,5...，表示往前推第一天扣1金币，第二天扣3金币，第三天扣5金币，以此类推。不开启阶梯则直接输入固定值，如：5，表示每次补签均扣除5金币
    private String signInMakeupCost;
    //补签可获得奖励
    private Boolean signInMakeupReward;
    //签到说明
    ...
    //显示好友删除 0不显示 1所有人显示 2内部号显示
    private Integer showFriendDelete;
}
