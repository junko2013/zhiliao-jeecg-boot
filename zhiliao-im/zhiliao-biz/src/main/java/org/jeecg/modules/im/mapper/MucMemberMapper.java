...
public interface MucMemberMapper extends BaseMapper<MucMember> {
    MyPage<MucMember> pagination(MyPage<MucMember> myPage, @Param("q") QMucMember q);
    MyPage<MucMember> pageApi(MyPage<MucMember> myPage, @Param("q") QMucMember q);
    ...
    Long updateTsVisible(Integer mucId, Integer userId, Long tsVisible);
}
